...
namespace _19T1021203.DataLayers.SQLServer
{
    ...
    {
        /// <summary>
        /// ở đây có hai hàm cực kỳ lạ đó là "DataReaderToOrder" và "DataReaderToOrderDetail",
        /// mục đích của hai hàm này là đổi dữ liệu sau khi truy vấn thành kiểu dữ liệu được khai báo trong
        /// DomainModel. Vì trong CSDL, order và order detail được lưu với các khóa ngoại để lấy tên và các thuộc tính
        /// của các sản phẩm trong khi ở trong domain model thì nó lưu hết tất cả thông tin vào 1 lớp.
        /// HAI HÀM NÀY LÀM MÀU LÀ CHỦ YẾU CHỨ CÓ VẺ VIẾT THẲNG VÀO TRONG HÀM GET, LIST LUÔN CŨNG ĐƯỢC (À MÀ ĐỠ PHẢI GHI LẠI NHIỀU LẦN)
        /// </summary>
